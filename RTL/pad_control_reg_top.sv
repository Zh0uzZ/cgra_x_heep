...
module pad_control_reg_top #(
  ...
  always_comb begin
    addr_hit = '0;
    addr_hit[ 0] = (reg_addr == PAD_CONTROL_PAD_MUX_I2C_SCL_OFFSET);
    addr_hit[ 1] = (reg_addr == PAD_CONTROL_PAD_MUX_I2C_SDA_OFFSET);
    addr_hit[ 2] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_CLK_OFFSET);
    addr_hit[ 3] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_RST_OFFSET);
    addr_hit[ 4] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_BOOT_SELECT_OFFSET);
    addr_hit[ 5] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_EXECUTE_FROM_FLASH_OFFSET);
    addr_hit[ 6] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TCK_OFFSET);
    addr_hit[ 7] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TMS_OFFSET);
    addr_hit[ 8] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TRST_OFFSET);
    addr_hit[ 9] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TDI_OFFSET);
    addr_hit[10] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_JTAG_TDO_OFFSET);
    addr_hit[11] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_UART_RX_OFFSET);
    addr_hit[12] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_UART_TX_OFFSET);
    addr_hit[13] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_EXIT_VALID_OFFSET);
    addr_hit[14] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_0_OFFSET);
    addr_hit[15] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_1_OFFSET);
    addr_hit[16] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_2_OFFSET);
    addr_hit[17] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_3_OFFSET);
    addr_hit[18] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_4_OFFSET);
    addr_hit[19] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_5_OFFSET);
    addr_hit[20] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_6_OFFSET);
    addr_hit[21] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_7_OFFSET);
    addr_hit[22] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_8_OFFSET);
    addr_hit[23] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_9_OFFSET);
    addr_hit[24] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_10_OFFSET);
    addr_hit[25] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_11_OFFSET);
    addr_hit[26] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_12_OFFSET);
    addr_hit[27] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_13_OFFSET);
    addr_hit[28] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_14_OFFSET);
    addr_hit[29] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_15_OFFSET);
    addr_hit[30] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_16_OFFSET);
    addr_hit[31] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_17_OFFSET);
    addr_hit[32] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_18_OFFSET);
    addr_hit[33] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_19_OFFSET);
    addr_hit[34] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_20_OFFSET);
    addr_hit[35] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_21_OFFSET);
    addr_hit[36] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_22_OFFSET);
    addr_hit[37] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_23_OFFSET);
    addr_hit[38] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_24_OFFSET);
    addr_hit[39] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_25_OFFSET);
    addr_hit[40] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_26_OFFSET);
    addr_hit[41] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_27_OFFSET);
    addr_hit[42] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_28_OFFSET);
    addr_hit[43] = (reg_addr == PAD_CONTROL_PAD_ATTRIBUTE_GPIO_29_OFFSET);
  ...
  assign pad_mux_i2c_scl_we = addr_hit[0] & reg_we & !reg_error;
  assign pad_mux_i2c_scl_wd = reg_wdata[3:0];

  assign pad_mux_i2c_sda_we = addr_hit[1] & reg_we & !reg_error;
  assign pad_mux_i2c_sda_wd = reg_wdata[3:0];

  assign pad_attribute_clk_we = addr_hit[2] & reg_we & !reg_error;
  assign pad_attribute_clk_wd = reg_wdata[7:0];

  assign pad_attribute_rst_we = addr_hit[3] & reg_we & !reg_error;
  assign pad_attribute_rst_wd = reg_wdata[7:0];

  assign pad_attribute_boot_select_we = addr_hit[4] & reg_we & !reg_error;
  assign pad_attribute_boot_select_wd = reg_wdata[7:0];

  assign pad_attribute_execute_from_flash_we = addr_hit[5] & reg_we & !reg_error;
  assign pad_attribute_execute_from_flash_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_tck_we = addr_hit[6] & reg_we & !reg_error;
  assign pad_attribute_jtag_tck_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_tms_we = addr_hit[7] & reg_we & !reg_error;
  assign pad_attribute_jtag_tms_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_trst_we = addr_hit[8] & reg_we & !reg_error;
  assign pad_attribute_jtag_trst_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_tdi_we = addr_hit[9] & reg_we & !reg_error;
  assign pad_attribute_jtag_tdi_wd = reg_wdata[7:0];

  assign pad_attribute_jtag_tdo_we = addr_hit[10] & reg_we & !reg_error;
  assign pad_attribute_jtag_tdo_wd = reg_wdata[7:0];

  assign pad_attribute_uart_rx_we = addr_hit[11] & reg_we & !reg_error;
  assign pad_attribute_uart_rx_wd = reg_wdata[7:0];

  assign pad_attribute_uart_tx_we = addr_hit[12] & reg_we & !reg_error;
  assign pad_attribute_uart_tx_wd = reg_wdata[7:0];

  assign pad_attribute_exit_valid_we = addr_hit[13] & reg_we & !reg_error;
  assign pad_attribute_exit_valid_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_0_we = addr_hit[14] & reg_we & !reg_error;
  assign pad_attribute_gpio_0_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_1_we = addr_hit[15] & reg_we & !reg_error;
  assign pad_attribute_gpio_1_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_2_we = addr_hit[16] & reg_we & !reg_error;
  assign pad_attribute_gpio_2_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_3_we = addr_hit[17] & reg_we & !reg_error;
  assign pad_attribute_gpio_3_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_4_we = addr_hit[18] & reg_we & !reg_error;
  assign pad_attribute_gpio_4_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_5_we = addr_hit[19] & reg_we & !reg_error;
  assign pad_attribute_gpio_5_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_6_we = addr_hit[20] & reg_we & !reg_error;
  assign pad_attribute_gpio_6_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_7_we = addr_hit[21] & reg_we & !reg_error;
  assign pad_attribute_gpio_7_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_8_we = addr_hit[22] & reg_we & !reg_error;
  assign pad_attribute_gpio_8_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_9_we = addr_hit[23] & reg_we & !reg_error;
  assign pad_attribute_gpio_9_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_10_we = addr_hit[24] & reg_we & !reg_error;
  assign pad_attribute_gpio_10_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_11_we = addr_hit[25] & reg_we & !reg_error;
  assign pad_attribute_gpio_11_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_12_we = addr_hit[26] & reg_we & !reg_error;
  assign pad_attribute_gpio_12_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_13_we = addr_hit[27] & reg_we & !reg_error;
  assign pad_attribute_gpio_13_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_14_we = addr_hit[28] & reg_we & !reg_error;
  assign pad_attribute_gpio_14_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_15_we = addr_hit[29] & reg_we & !reg_error;
  assign pad_attribute_gpio_15_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_16_we = addr_hit[30] & reg_we & !reg_error;
  assign pad_attribute_gpio_16_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_17_we = addr_hit[31] & reg_we & !reg_error;
  assign pad_attribute_gpio_17_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_18_we = addr_hit[32] & reg_we & !reg_error;
  assign pad_attribute_gpio_18_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_19_we = addr_hit[33] & reg_we & !reg_error;
  assign pad_attribute_gpio_19_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_20_we = addr_hit[34] & reg_we & !reg_error;
  assign pad_attribute_gpio_20_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_21_we = addr_hit[35] & reg_we & !reg_error;
  assign pad_attribute_gpio_21_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_22_we = addr_hit[36] & reg_we & !reg_error;
  assign pad_attribute_gpio_22_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_23_we = addr_hit[37] & reg_we & !reg_error;
  assign pad_attribute_gpio_23_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_24_we = addr_hit[38] & reg_we & !reg_error;
  assign pad_attribute_gpio_24_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_25_we = addr_hit[39] & reg_we & !reg_error;
  assign pad_attribute_gpio_25_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_26_we = addr_hit[40] & reg_we & !reg_error;
  assign pad_attribute_gpio_26_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_27_we = addr_hit[41] & reg_we & !reg_error;
  assign pad_attribute_gpio_27_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_28_we = addr_hit[42] & reg_we & !reg_error;
  assign pad_attribute_gpio_28_wd = reg_wdata[7:0];

  assign pad_attribute_gpio_29_we = addr_hit[43] & reg_we & !reg_error;
